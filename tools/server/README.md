...
| `--no-spec-gpu-pipeline` | disable automatic GPU acceptance and prefetch for MTP and EAGLE3; see [automatic GPU pipeline](../../docs/speculative.md#automatic-gpu-pipeline) |
